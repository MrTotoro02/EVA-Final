...
import pe.edu.narutoapp.databinding.ActivityLoginBinding
...
class LoginActivity : AppCompatActivity() {
    ...
    private fun signInWithGoogle() {
        val googleSingOptions =
            GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN).requestIdToken("111108196349834995079")
                .requestEmail().build()
